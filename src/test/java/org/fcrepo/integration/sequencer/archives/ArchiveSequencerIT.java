...
public class ArchiveSequencerIT extends AbstractResourceIT {
	...
	public void testArchiveSequencer() throws Exception {
        ...
        final HttpGet dsListGet = new HttpGet(serverAddress + "/rest/objects/" + pid + "/datastreams/");
		String dsList = EntityUtils.toString(client.execute(dsListGet).getEntity());
        ...
        final HttpGet extractedContents = new HttpGet( serverAddress + "/rest/objects/" + pid + "/datastreams/" + dsid + "_archiveContents/content");
        String actual = EntityUtils.toString(client.execute(extractedContents).getEntity());
